...
a single consolidated Rosetta Stone for moving fluently between platforms. Where a
clean one-to-one mapping does not exist, the prose notes the closest analog and the
caveat.
\end{notebox}
