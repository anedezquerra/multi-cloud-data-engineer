...
\hypersetup{
    ...
    bookmarksopen=true,
    pdftitle={Databricks Master Data Engineer},
    pdfauthor={PhD Aned Esquerra Arguelles},
    pdfsubject={A Comprehensive, Hands-On Academic Guide to Data Engineering on the Databricks Data Intelligence Platform},
    pdfkeywords={Databricks, data engineering, Delta Lake, lakehouse, Unity Catalog, Apache Spark, Delta Live Tables, Auto Loader, Structured Streaming, MLflow, Mosaic AI, Asset Bundles, Medallion Architecture},
}
