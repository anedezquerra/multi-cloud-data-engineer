...
\hypersetup{
    ...
    bookmarksopen=true,
    pdftitle={Snowflake Master Data Engineer},
    pdfauthor={PhD Aned Esquerra Arguelles},
    pdfsubject={A Comprehensive, Hands-On Academic Guide to Snowflake Architecture, Snowpark, and DataOps},
    pdfkeywords={Snowflake, virtual warehouses, micro-partitions, Snowpark, Streams, Tasks, Time Travel, zero-copy cloning, governance, data engineering},
}
