...
\hypersetup{
    ...
    bookmarksopen=true,
    pdftitle={MongoDB Master Data Engineer and Senior Architect},
    pdfauthor={PhD Aned Esquerra Arguelles},
    pdfsubject={A Comprehensive, Hands-On Academic Guide to MongoDB Architecture, Aggregation, Security, and DataOps},
    pdfkeywords={MongoDB, WiredTiger, document modeling, aggregation pipeline, sharding, replica sets, Atlas, vector search, change streams, DataOps},
}
...
\lstdefinelanguage{JavaScript}{
    keywords={break,case,catch,const,continue,default,delete,do,else,false,for,function,if,in,let,new,null,return,switch,true,try,var,while},
    keywordstyle=\color{magenta}\bfseries,
    sensitive=true,
    comment=[l]{//},
    morecomment=[s]{/*}{*/},
...
\lstdefinelanguage{bash}{
    keywords={if,then,else,fi,for,do,done,while,case,esac,function,in},
    keywordstyle=\color{magenta}\bfseries,
    sensitive=true,
    comment=[l]{\#},
    morestring=[b]',
