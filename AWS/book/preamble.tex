...
\hypersetup{
    ...
    bookmarksopen=true,
    pdftitle={AWS Master Data Engineer},
    pdfauthor={PhD Aned Esquerra Arguelles},
    pdfsubject={A Comprehensive, Hands-On Academic Guide to Data Engineering on Amazon Web Services},
    pdfkeywords={AWS, data engineering, Amazon S3, Redshift, AWS Glue, EMR, Kinesis, Lake Formation, Data Lakehouse, Athena, DataSync, Storage Gateway, Snow Family},
}
