...
\hypersetup{
    ...
    bookmarksopen=true,
    pdftitle={GCP Master Data Engineer},
    pdfauthor={PhD Aned Esquerra Arguelles},
    pdfsubject={A Comprehensive, Hands-On Academic Guide to Data Engineering on Google Cloud},
    pdfkeywords={Google Cloud, GCP, data engineering, Cloud Storage, BigQuery, Dataflow, Dataproc, Pub/Sub, Spanner, Bigtable, Composer, Dataplex},
}
